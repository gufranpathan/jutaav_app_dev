...
public object Logger {
   ...
   public fun debugE(className: String, message: String) {
        ...
        Log.e(JuttavConfig.APP_VERSION + " " + System.currentTimeMillis() + " :  ", "$className : $message")
        addRecordToLog(JuttavConfig.APP_VERSION + " " + System.currentTimeMillis() + " :  " + className + " : " + message)


    }

    public fun debugE(message: String) {
        Log.e(JuttavConfig.APP_VERSION + " " + System.currentTimeMillis() + " :  ", message)
        addRecordToLog(JuttavConfig.APP_VERSION + " " + System.currentTimeMillis() + " :  " + " : " + message)
    }
    ...
    public  fun debugE(message: String, execption: Boolean) {
        ...
        Log.e(JuttavConfig.APP_VERSION + " " + System.currentTimeMillis() + " :  ", errormessage)
        addRecordToLog(JuttavConfig.APP_VERSION + " " + System.currentTimeMillis() + " :  " + errormessage)
    }

    public fun debugV(message: String) {
        Log.v(JuttavConfig.APP_VERSION + " " + System.currentTimeMillis() + " :  ", message)
        addRecordToLog(JuttavConfig.APP_VERSION + " " + System.currentTimeMillis() + " :  " + message)
    }

    public fun debugV(className: String, message: String) {
        Log.v(JuttavConfig.APP_VERSION + " " + System.currentTimeMillis() + " :  ", "$className:$message")
        addRecordToLog(JuttavConfig.APP_VERSION + " " + System.currentTimeMillis() + " :  " + className + ":" + message)
    }
